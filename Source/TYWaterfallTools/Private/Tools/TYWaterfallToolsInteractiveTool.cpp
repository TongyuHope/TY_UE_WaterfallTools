...
#include "TYWaterfallToolsInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UTYWaterfallToolsInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UTYWaterfallToolsInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UTYWaterfallToolsInteractiveTool* NewTool = NewObject<UTYWaterfallToolsInteractiveTool>(SceneState.ToolManager);
...
UTYWaterfallToolsInteractiveToolProperties::UTYWaterfallToolsInteractiveToolProperties()
{
...
void UTYWaterfallToolsInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UTYWaterfallToolsInteractiveTool::Setup()
{
	...
	Properties = NewObject<UTYWaterfallToolsInteractiveToolProperties>(this, "Measurement");
...
void UTYWaterfallToolsInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UTYWaterfallToolsInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UTYWaterfallToolsInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UTYWaterfallToolsInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UTYWaterfallToolsInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UTYWaterfallToolsInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UTYWaterfallToolsInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UTYWaterfallToolsInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UTYWaterfallToolsInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
