...
#include "TYWaterfallToolsInteractiveTool.generated.h"


/**
 * Builder for UTYWaterfallToolsInteractiveTool
 */
UCLASS()
class TYWATERFALLTOOLS_API UTYWaterfallToolsInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UTYWaterfallToolsInteractiveTool
 */
UCLASS(Transient)
class TYWATERFALLTOOLS_API UTYWaterfallToolsInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UTYWaterfallToolsInteractiveToolProperties();
...
/**
 * UTYWaterfallToolsInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class TYWATERFALLTOOLS_API UTYWaterfallToolsInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTYWaterfallToolsInteractiveToolProperties> Properties;
